...
public class GameWindow extends JFrame 
{
	...
	public GameWindow() {
		...
		JLabel lblPhase = new JLabel("SelectAction");
		...
		JButton btnAction = new JButton("Play Action");
		...
		panel_4.add(btnAction, BorderLayout.WEST);
		...
		JTextArea taTurnLogs = new JTextArea();
